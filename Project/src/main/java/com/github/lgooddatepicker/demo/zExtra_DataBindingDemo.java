 ...
 * with the date and time picker components. This demo was created with the NetBeans visual form
 * designer. Note: The source code for this demo was automatically generated by the visual designer,
 * and it would probably not be intuitive to read the source code directly.
 *
 ...
 * components.
 *
 * This demo class can be run independently (using its own main function), or it can be run from the
 * "Show_DataBindingDemo" button in the FullDemo.
 */
