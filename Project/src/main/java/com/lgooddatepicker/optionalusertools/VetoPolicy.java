...
/**
 * VetoPolicy, A VetoPolicy can be implemented to prevent specified non-null dates from being
 * selected in your date picker. A vetoed date cannot be selected by typing in the date manually,
 * and cannot be selected by using the mouse. See the demo class for an example of implementing a
 * VetoPolicy.
 *
